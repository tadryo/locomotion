...
class Go2TerrainEnv:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, terrain_cfg, show_viewer=False):
        ...
        self.terrain = self.scene.add_entity(
            gs.morphs.Terrain(
                n_subterrains=(terrain_cfg["n_subterrains_x"], terrain_cfg["n_subterrains_y"]),
    ...
    def reset_idx(self, envs_idx):
        ...
        # reset base with terrain height offset
